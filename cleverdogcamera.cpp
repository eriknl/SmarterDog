...
CleverdogCamera::CleverdogCamera(QHostAddress address, QString cid, QString mac, QString firmware) : address(address), cid(cid), mac(mac), firmware(firmware)
{
	recaster = new MediaRecaster();
}
